...
const getSaleCategory = (sale: { servico?: string | null; produto?: string | null }) => {
  ...
  if (["gestao de trafego", "tr�fego", "trafego"].includes(normalized)) return "Tr�fego";
  if (["captacao/edicao de conteudo", "captacao", "capta��o", "capta��o/edi��o de conte�do"].includes(normalized)) return "Capta��o";
