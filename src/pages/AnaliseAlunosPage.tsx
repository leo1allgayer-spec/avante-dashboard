...
const fieldLabels: Record<string, string> = {
  ...
  objetivo_principal: "Qual era o seu principal objetivo ao buscar o curso?",
  segmento: "Qual seu segmento?",
  fator_determinante: "Qual foi o fator determinante para voce fechar com a Avante?",
  dor_principal: "Qual foi a sua principal dificuldade ou dor antes de procurar o curso?",
  consultor: "Consultor",
  tempo_atendimento: "Em quanto tempo voce foi atendido(a) apos o primeiro contato?",
  atendimento_rapido: "Voce considera que o atendimento foi rapido?",
  nota_whatsapp: "De 0 a 10, quanto voce gostou do atendimento no WhatsApp?",
  nota_curso: "De 0 a 10, qual nota voce da para o curso?",
  nota_interna: "Nota interna",
  forma_atendimento: "Nosso atendimento e feito com audios e textos. Gostou dessa forma?",
  motivacao_fechar: "O que mais te motivou a fechar o curso conosco?",
  valor_curso_opiniao: "O que achou sobre o valor do curso pelo que e entregue?",
  sugestao_atendimento: "Sugestao para melhorarmos nosso atendimento",
  indicaria_alguem: "Voce conhece alguem que indicaria este curso?",
  nota_indicacao: "De 0 a 10, o quanto voce indicaria a Avante para um amigo?",
};
