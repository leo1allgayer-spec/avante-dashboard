...
const sections = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "meta_servicos", label: "Negócio Local", prefix: "" },
      { key: "meta_social_media", label: "Social Media", prefix: "" },
      { key: "super_meta_servicos", label: "Super Negócio Local", prefix: "" },
      { key: "super_meta_social_media", label: "Super Social Media", prefix: "" },
      { key: "meta_suporte_extra", label: "Suporte Extra", prefix: "" },
      { key: "super_meta_suporte_extra", label: "Super Suporte Extra", prefix: "" },
      { key: "meta_site", label: "Site", prefix: "" },
      { key: "super_meta_site", label: "Super Site", prefix: "" },
      { key: "meta_captacao_edicao", label: "Captação/Edição", prefix: "" },
      { key: "super_meta_captacao_edicao", label: "Super Captação/Edição", prefix: "" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "valor_servicos", label: "Negócio Local", prefix: "R$" },
      { key: "valor_social_media", label: "Social Media", prefix: "R$" },
      { key: "super_valor_servicos", label: "Super Negócio Local", prefix: "R$" },
      { key: "super_valor_social_media", label: "Super Social Media", prefix: "R$" },
      { key: "valor_suporte_extra", label: "Suporte Extra", prefix: "R$" },
      { key: "super_valor_suporte_extra", label: "Super Suporte Extra", prefix: "R$" },
      { key: "valor_site", label: "Site", prefix: "R$" },
      { key: "super_valor_site", label: "Super Site", prefix: "R$" },
      { key: "valor_captacao_edicao", label: "Captação/Edição", prefix: "R$" },
      { key: "super_valor_captacao_edicao", label: "Super Captação/Edição", prefix: "R$" },
...
const createEmptyForm = (data?: DailyMetrics | null) => ({
  ...
  meta_servicos: data?.meta_servicos || 0,
  meta_social_media: data?.meta_social_media || 0,
  meta_suporte_extra: data?.meta_suporte_extra || 0,
  meta_site: data?.meta_site || 0,
  meta_negocio_local: data?.meta_negocio_local || 0,
  meta_captacao_edicao: data?.meta_captacao_edicao || 0,
  meta_crm: data?.meta_crm || 0,
  meta_upsell: data?.meta_upsell || 0,
  super_meta_cursos: data?.super_meta_cursos || 0,
  super_meta_servicos: data?.super_meta_servicos || 0,
  super_meta_social_media: data?.super_meta_social_media || 0,
  super_meta_suporte_extra: data?.super_meta_suporte_extra || 0,
  super_meta_site: data?.super_meta_site || 0,
  super_meta_negocio_local: data?.super_meta_negocio_local || 0,
  super_meta_captacao_edicao: data?.super_meta_captacao_edicao || 0,
  ...
  valor_social_media: data?.valor_social_media || 0,
  valor_suporte_extra: data?.valor_suporte_extra || 0,
  valor_site: data?.valor_site || 0,
  valor_negocio_local: data?.valor_negocio_local || 0,
  valor_captacao_edicao: data?.valor_captacao_edicao || 0,
  valor_crm: data?.valor_crm || 0,
  valor_upsell: data?.valor_upsell || 0,
  super_valor_cursos: data?.super_valor_cursos || 0,
  super_valor_servicos: data?.super_valor_servicos || 0,
  super_valor_social_media: data?.super_valor_social_media || 0,
  super_valor_suporte_extra: data?.super_valor_suporte_extra || 0,
  super_valor_site: data?.super_valor_site || 0,
  super_valor_negocio_local: data?.super_valor_negocio_local || 0,
  super_valor_captacao_edicao: data?.super_valor_captacao_edicao || 0,
...
const SUPER_TARGET_VALUE_FIELDS = [
  ...
  "super_valor_social_media",
  "super_valor_suporte_extra",
  "super_valor_site",
  "super_valor_captacao_edicao",
  "super_valor_crm",
  "super_valor_upsell",
] as const;
