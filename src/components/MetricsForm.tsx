...
const sections = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "meta_negocio_local", label: "Captação/Edição", prefix: "" },
      { key: "super_meta_negocio_local", label: "Super Captação/Edição", prefix: "" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "valor_negocio_local", label: "Captação/Edição", prefix: "R$" },
      { key: "super_valor_negocio_local", label: "Super Captação/Edição", prefix: "R$" },
